RENAME "1.0.0" "TengwarElficaGlaemUnicode" "Tengwar Elfica GlaemUnicode" "Tengwar Elfica GlaemUnicode"
...
# Put everything that's already in the unicode part (put by Enrique) just before
MB 0xE000 0xE07F 0xD000

##############################

X _elfica_partial.mod
